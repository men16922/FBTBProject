...
function frm_submit(){
	...
	if(!reg.test(branch_address.value) || (branch_address.value.length) <= 2 || (branch_address.value.length) > 33){ 
		alert("유효한 주소값을 넣어주세요.");
		return; //값을 DB로 전달하지 않고 return
	}
      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <div class="col" style="background-color:white">
                ...
                <div class="row mt-3">
                    <!--타이틀-->
                    <div class="col-4 mt-3" ><span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: rgb(46, 46, 46); font-weight:bold; font-size: 36px;">매장 등록</span></div>
                    <div class="col"></div>
                    <!---네비게이터-->
                    <div class="col-6">
                        <div class="row">                                   
                            ...
                            <div class="col mt-5" style="display:inline;">     
                                <ul style="list-style:none; margin-top: 10px; margin-bottom: 5px; margin-left: 100px; text-decoration-color: gray">
                                    <li>
                                        ...
                                        >
                                        <a style="color: gray; font-size: 14px" href="${pageContext.request.contextPath }/management/store_add.do">매장등록</a>
...
<c:if test="${!empty sessionUser && sessionUser.deptTypeVo.dept_type_no==1 }">
			...
			<form action = "./store_add_process.do" method="get" id="frm" >     
			       <!-- 테이블 내용 -->
               <div class="row mt-5">
                  <div class="col-3"></div>
                  <div class="col">
                  <table class="table table-hover shadow-sm p-3 mb-2 bg-white rounded">
                     ...
                     <tr>
                        ...
                        <td><input id="branch_name" placeholder="매장명을 입력해주세요." name="branch_name" type="text" class="form-control"></td>
                        <td></td>
                     </tr>
                     ...
                     <tr>
                        ...
                        <td>
                        	<input id="branch_address" placeholder="주소를 입력해주세요." name="branch_address" type="text" class="form-control" onclick="sample4_execDaumPostcode()">
						</td>
                        <td></td>
                     </tr>
                     ...
                     <tr>
                        ...
                        <td><input id="branch_phone" placeholder="연락처를 입력해주세요." name="branch_phone" type="text" class="form-control"></td>
                        <td></td>
                     </tr>
                     ...
                     <div class="row mt-3 mb-5">
                        ...
                        <div class="col"></div>
                        <div class="col-3">
						<input type="button" value="등록" class="btn btn-primary btn-block" onclick="frm_submit()">                        </div>
                     </div>
                     
                  </div>
                  <div class="col-3"></div>
               </div>
            </form></c:if><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
