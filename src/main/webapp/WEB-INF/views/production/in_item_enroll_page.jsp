...
function frm_submit() {
	...
	var comp_price = document.getElementById("comp_price").value;
	...
	if(comp_name == ""){
		...
		frm.submit();
		var returnValue = confirm("재고 입고등록을 하시겠습니까 ?");
		console.log(returnValue);
		if(returnValue == true) {
			document.location.href='./none_in_item_page.do'; 
		} else {
			return false;
		}
	}
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-2"
				...
				<ul class="list-group list-group-flush">
					...
					<li class="list-group-item"><h5>
							<a style="color: #6c737e;"
								href="${pageContext.request.contextPath }/production/none_in_item_page.do">발주입고등록</a>
						</h5></li>
					<li class="list-group-item"><h5>
							<a style="color: #6c737e;"
        ...
        <div class="row">
            ...
            <div class="col" style="background-color:white">
                ...
                <div class="row mt-3">
                    <!--타이틀-->
                    <div class="col-4 mt-3" ><span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: rgb(46, 46, 46); font-weight:bold; font-size: 36px;">부품입고</span></div>
                    <div class="col"></div>
                    <!---네비게이터-->
                    <div class="col-6">
                        <div class="row">                                   
                        ...
                        <div class="row"> 
                            ...
                            <div class="col mt-5" style="display:inline;">     
                                <ul style="list-style:none; margin-top: 10px; margin-bottom: 5px; margin-left: 100px; text-decoration-color: gray">
                                    <li>
                                        <a style="color: gray; font-size: 14px" href="#">상세경로</a>
                                        >
				...
				<form action="./in_item_enroll_process.do" method="post" id="frm">
					...
					<div class="form-group row mt-3">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="comp_price" id="comp_price"
								placeholder="부품가격을 입력해주세요">
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col"></div>
						<div class="col">
							 <input type="button" class="btn btn-primary btn-sm btn-block" onclick="frm_submit()" value="등록하기" />
						</div>
					</div>
