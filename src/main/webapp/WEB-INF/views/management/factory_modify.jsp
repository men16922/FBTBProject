...
<body>
      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <div class="col" style="background-color:white">
                ...
                <div class="row mt-3">
                    <!--타이틀-->
                    <div class="col-4 mt-3" ><span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: rgb(46, 46, 46); font-weight:bold; font-size: 36px;">공장 정보 수정</span></div>
                    <div class="col"></div>
                    <!---네비게이터-->
                    <div class="col-6">
                        <div class="row">                                   
                                ...
                                <ul style="list-style:none; margin-top: 10px; margin-bottom: 5px; margin-left: 100px; text-decoration-color: gray">
                                    <li>
                                        ...
                                        <a style="color: gray; font-size: 14px" href="${pageContext.request.contextPath }/management/factory_view.do">공장관리</a>
                                         >
                                        <a style="color: gray; font-size: 14px" href="#">공장정보 수정</a>
  ...
  <c:if test="${!empty sessionUser && sessionUser.deptTypeVo.dept_type_no==1 }">
             <form action="./factory_modify_process.do" method="post" id="frm">
               ...
               <div class="row mt-5">
                  ...
                  <table class="table table-hover shadow-sm p-3 mb-2 bg-white rounded">
                     ...
                     <div class="row mt-3 mb-5">
                        ...
                        <div class="col-3">
                           <a href="./factory_view.do" class="btn btn-primary btn-block">목록으로</a></div>
                        </div>
                     </div>
                     <div class="col-3"></div>
                  </div>
