					...
					<div class="row">
						...
						<div class="col" style="background-color: white">
											...
											<table
												...
												<tbody>
													<tr>
														...
														<c:choose>
														<c:when test="${detailMap.processStatusVo.process_no==3 && data.processStatusVo.flag eq 'R'.charAt(0)}">						 		 
														 		공장수정중
														 	</c:when>
														...
														<c:choose>
														<c:when test="${detailMap.processStatusVo.process_no==1 && sessionUser.deptTypeVo.dept_type_no==3 && detailMap.processStatusVo.flag eq 'Y'.charAt(0) && sessionUser.employeeRankVo.rank_no<=5}">
							...
							<div class="row"> <!-- 버튼들... -->
								 ...
								 <div class="col-2">
								 <c:choose>
														<c:when test="${detailMap.processStatusVo.process_no==1 && sessionUser.deptTypeVo.dept_type_no==3 && detailMap.processStatusVo.flag eq 'Y'.charAt(0)}">
														<form action="${pageContext.request.contextPath}/sales/store_order_view_process.do" method="post">
														<input type="hidden" name="check" value="${detailMap.processStatusVo.process_status_no}">
														<input type="submit" value="발주취소" class="btn btn-primary btn-block" >
														
														</form>
															</c:when>
														<c:when test="${detailMap.processStatusVo.process_no==5 && sessionUser.deptTypeVo.dept_type_no==3 && detailMap.processStatusVo.flag eq 'Y'.charAt(0)}">
														<form action="${pageContext.request.contextPath}/sales/store_in_process.do" method="post">
														<input type="hidden" name="check" value="${detailMap.storeOrderDetailVo.store_order_detail_no}">
														<input type="submit" value="입고등록" class="btn btn-primary btn-block" >
														</form>
															</c:when>	
											...
											<div class="row">
												...
												<div class="col-3">
													...
													<div class="row">
														<div class="col ml-4">
														<c:choose>
															<c:when test="${detailMap.processStatusVo.process_no == 3 && detailMap.processStatusVo.flag eq 'Y'.charAt(0) || detailMap.processStatusVo.flag eq 'U'.charAt(0)}">
											...
											<table
												...
												<tbody>
													<tr>
														...
														<td><fmt:formatDate value="${data.processStatusVo.confirm_date }" pattern="yy.MM.dd.hh.mm.ss" />
														</td>
						...
						<div class="row mb-5">
							...
							<div class="col">
								...
								<a href="javascript:history.back();"><input type="button" class="btn btn-primary btn-block" value="목록으로">
							</div>
