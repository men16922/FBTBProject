		...
		<!--  메인 기능 나오는 곳 -->
         <div class="col pl-5 pr-5">
            ...
            <div class="row">
                ...
                <div class="row mt-3">
                    <!--타이틀-->
                  <div class="col-4 mt-3" ><span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: rgb(46, 46, 46); font-weight:bold; font-size: 36px;">영업부 게시판</span></div>
              	  <div class="col"></div>
              	  <!---네비게이터-->
                    <div class="col-7">
                        <div class="row">                                   
							...
							<tbody>
								<tr>
									...
									<tr style="font-weight:bold" bgcolor="#e8ecf1">
										...
										<td class="text-center">
										<a href="${pageContext.request.contextPath }/sales/board_read_page.do?dept_board_no=${data.departmentBoardVo.dept_board_no }">${data.departmentBoardVo.dept_board_title }</a></td>
		...
		<div class="row mt-3">
					...
					<div class="col-2">
						<a class="btn btn-primary btn-sm btn-block"
							href="${pageContext.request.contextPath }/sales/board_write_page.do">글쓰기</a>
					</div>
				</div>
			</div>
			</div>
