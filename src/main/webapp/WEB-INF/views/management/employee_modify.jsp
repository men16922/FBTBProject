      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <div class="col" style="background-color:white">
                ...
                <div class="row mt-3">
                    <!--타이틀-->
                    <div class="col-4 mt-3" ><span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: rgb(46, 46, 46); font-weight:bold; font-size: 36px;">사원정보수정</span></div>
                    <div class="col"></div>
                    <!---네비게이터-->
                    <div class="col-6">
                        <div class="row">                                   
                            ...
                            <div class="col mt-5" style="display:inline;">     
                                <ul style="list-style:none; margin-top: 10px; margin-bottom: 5px; margin-left: 100px; text-decoration-color: gray">
                                    <li>
                                        ...
                                        >
                                        <a style="color: gray; font-size: 14px" href="#">사원정보 수정</a>
                                    </li>
                                </ul>             
                            </div>      
                        </div>
            ...
            <form action="./employee_modify_process.do" method="get" id="frm">       
                <!-- 테이블 내용 -->
               <div class="row mt-5">
                  <div class="col-2"></div>
                  <div class="col">
                  <table class="table table-hover shadow-sm p-3 mb-2 bg-white rounded">
                     ...
                     <tr>
                        ...
                        <td>
                       <input id="emp_no" name="emp_no" type="text" class="form-control" value=${param.emp_no } readOnly> 
                        </td>
                        <td></td>
                     </tr>
                     ...
                     <tr>
                        ...
                        <td><input id="emp_name" name="emp_name" type="text" class="form-control" value=${employeeVo.emp_name }></td>
                        <td></td>
                     </tr>
                     ...
                     <tr>
                        ...
                        <td><input id="emp_email" name="emp_email" type="text" class="form-control" value="${employeeVo.emp_email }"></td>
                        <td></td>
                     </tr>
                     
                     <tr>
                        <th class="shadow-none p-3 mb-5 bg-light rounded">연락처</th>
                        <td><input id="emp_phone" name="emp_phone" type="text" class="form-control" value="${employeeVo.emp_phone }"></td>
                     </tr>
                     
                      <tr>
                        <th class="shadow-none p-3 mb-5 bg-light rounded">입사일</th>
                        <td><fmt:formatDate value="${employeeVo.start_date }" pattern="yyyy년 MM월 dd일"/></td>
                     </tr>
                     
                      <tr>
                        <th class="shadow-none p-3 mb-5 bg-light rounded">주소</th>
                        <td><input id="emp_address" name="emp_address" type="text" class="form-control" value="${employeeVo.emp_address }" onclick="sample4_execDaumPostcode()"></td>
                     </tr>
                     ...
                     <tr>
                        <th class="shadow-none p-3 mb-5 bg-light rounded">생년월일</th>
                        <td>${employeeVo.emp_resident_num}</td>
                     </tr>
                     ...
                     <div class="row mt-3 mb-5">
                        ...
                        <div class="col"></div>
                        <div class="col-2">
                           <input type="button" value="수정완료" class="btn btn-primary btn-block" onclick="frm_submit()">
                        </div>
                     </div>
