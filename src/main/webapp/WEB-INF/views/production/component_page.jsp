					...
					<div class="col" style="background-color: white">
						...
						<div class="row mt-3">
							...
							<div class="col-4 mt-3">
								<span
									style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: rgb(46, 46, 46); font-weight: bold; font-size: 36px;">부품조회</span>
							</div>
							<div class="col"></div>
							<!---네비게이터-->
							<div class="col-6">
									...
									<div class="col">
										<table
											...
											<thead class="shadow-none p-3 mb-5 bg-light rounded">
												<tr>
													<td class="text-center">부품번호</td>
													<td class="text-center">부품이름</td>
													<td class="text-center">부품수량</td>
													<td class="text-center">부품가격</td>
												</tr>
											</thead>
											<tbody>
												<c:forEach items="${dataList }" var="data">
													<tr>
														<td class="text-center">${data.componentStockVo.comp_no }</td>
														<td class="text-center">${data.productComponentVo.comp_name }</td>
														<td class="text-center">${data.componentStockVo.comp_qty }</td>
