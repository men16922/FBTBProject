      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <div class="col" style="background-color:white">
                ...
                <div class="row mt-3">
                    <!--타이틀-->
                    <div class="col-4 mt-3" ><span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: rgb(46, 46, 46); font-weight:bold; font-size: 36px;">보낸쪽지함</span></div>
                    <div class="col"></div>
                    <!---네비게이터-->
                    <div class="col-6">
                        <div class="row">                                   
                            ...
                            <div class="col mt-5" style="display:inline;">     
                                <ul style="list-style:none; margin-top: 10px; margin-bottom: 5px; margin-left: 100px; text-decoration-color: gray">
                                    <li>
                                        ...
                                        >
                                        <a style="color: gray; font-size: 14px">보낸쪽지함</a>
                ...
                <!--1. 타이틀, 네비게이터 끝-->
				<form action="${pageContext.request.contextPath }/message/list_sended_message_page.do" method="post">
					<div class="row my-3">
						<div class="col"></div>
						<div class="col-6">
							<div class="row">
							...
							<table class="table table-hover shadow-sm p-3 mb-5 bg-white rounded">
								...
								<c:forEach var="data" items="${messageData }">
									<tr>
										...
										<td>${data.branchVoRev.branch_name}</td>
										<td>${data.employeeVoRev.emp_name}</td>													
