                            ...
                            <div class="col mt-5" style="display:inline;">     
                                <ul style="list-style:none; margin-top: 10px; margin-bottom: 5px; margin-left: 100px; text-decoration-color: gray">
                                    <li>
                                        ...
                                        >
                                        <a style="color: gray; font-size: 14px" href="#">사원정보 확인</a>
                                    </li>
                                </ul>             
                            </div>      
                        </div>
...
<c:if test="${!empty sessionUser && sessionUser.deptTypeVo.dept_type_no==1 }">
           <form action="${pageContext.request.contextPath }/management/employee_view.do" method="post" id="frm">
            ...
            <!-- 테이블 내용 -->
               <div class="row mt-5">
                  ...
                  <table class="table table-hover shadow-sm p-3 mb-2 bg-white rounded">
                     ...
                     <tr>
                        <th class="shadow-none p-3 mb-5 bg-light rounded">부서/지점/직급</th>
                        <td>${deptVo.dept_name } / ${branchVo.branch_name } / ${employeeRankVo.rank_name }</td>
                        <td></td>
                     </tr>
                     ...
                     <div class="row mt-3 mb-5">
                        ...
                        <div class="col"></div>
                        <div class="col-3">
                           <a class="btn btn-primary btn-block" href="./employee_modify.do?emp_no=${employeeVo.emp_no}">정보수정</a>
                        </div>
                         <div class="col-3">
                           <a class="btn btn-primary btn-block" href="./employee_view.do">목록으로</a>
                        </div>
                     </div>
