      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <div class="col" style="background-color:white">
                ...
                <div class="row mt-3">
                    <!--타이틀-->
                    <div class="col-4 mt-3" ><span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: rgb(46, 46, 46); font-weight:bold; font-size: 36px;">상품 정보 상세</span></div>
                    <div class="col"></div>
                    <!---네비게이터-->
                    <div class="col-6">
                        <div class="row">                                   
                            ...
                            <div class="col mt-5" style="display:inline;">     
                                <ul style="list-style:none; margin-top: 10px; margin-bottom: 5px; margin-left: 100px; text-decoration-color: gray">
                                    <li>
                                       ...
                                       >
                                       <a style="color: gray; font-size: 14px" href="#">상품 정보 상세</a>
				...
				<form action="./read_product_page.do" method="post"> 
				           <!-- 테이블 내용 -->
               <div class="row mt-5">
                  <div class="col-1">
                  ...
                  <c:if test="${!empty read_product_page.fileVoList.product_file_link_path }">
						<img src="/upload/${read_product_page.fileVoList.product_file_link_path }" width="300" height="300"> 
						<br>	
					</c:if>
                  <div class="col">
                  ...
                  <table class="table table-hover shadow-sm p-3 mb-2 bg-white rounded">
                     ...
                     <tr>
                        <th class="shadow-none p-3 mb-5 bg-light rounded">제품번호</th>
                        <td>${read_product_page.productVo.product_no }</td>
                        <td></td>
                     </tr>
                     
                     <tr>
                        <th class="shadow-none p-3 mb-5 bg-light rounded">제품명</th>
                        <td>${read_product_page.productVo.product_name }</td>
                        <td></td>
                     </tr>
                     
                     <tr>
                        <th class="shadow-none p-3 mb-5 bg-light rounded">제품유형</th>
                        <td>${read_product_page.productTypeVo.product_type_name }</td>
                        <td></td>
                     </tr>
                     
                     <tr>
                        <th class="shadow-none p-3 mb-5 bg-light rounded">가격</th>
                        <td>${read_product_page.productVo.product_price }</td>
                     </tr>
                     
                     <tr>
                        <th class="shadow-none p-3 mb-5 bg-light rounded">제품설명</th>
                        <td>${read_product_page.productVo.product_detail }</td>
                        <td></td>
                     ...
                     <div class="row mt-3 mb-5">
                        ...
                        <div class="col-3">
                           <a href="./product_modify.do?product_type_no=${read_product_page.productVo.product_type_no }&product_no=${read_product_page.productVo.product_no }" class="btn btn-outline-primary btn-block">수정</a>
                        </div>
                        <div class="col-3">
                           <a href="./product_delete_process.do?product_no=${read_product_page.productVo.product_no }" class="btn btn-outline-primary btn-block">삭제</a>
                        </div>
                        <div class="col-3">
            ...
            </form></c:if><br><br><br><br><br><br><br><br><br><br>
