...
<script type="text/javascript">
	...
	function sendData(){
		...
		if(currPage==null)
	         ...
	         if(xmlhttp.readyState==4 && xmlhttp.status == 200){
	          ...
	          var innerHtml="";
	            for(pro of proList){
            		...
            		var protypeno= pro.productTypeVo.product_type_name;
            		innerHtml += "<td>"+protypeno+"</td>";
            		...
            		var branchstock= pro.branch_stockVo.branch_stock_qty;
            		innerHtml += "<td>"+branchstock+"</td>";
	      ...
	      var requestUrl = "${pageContext.request.contextPath }/sales/product_search_process.do?";
	      if(product_no==null)
	    	  product_no="";
	 ...
	 function sendprotype(){
			...
			if(currPage==null)
		         ...
		         if(xmlhttp.readyState==4 && xmlhttp.status == 200){
		          ...
		          var innerHtml="";
		            for(pro of proList){
		            	...
		            	innerHtml +="<tr>";
		                var prono= pro.branchStockVo.product_no;
		                innerHtml += "<td>"+prono+"</td>";
	            		...
	            		var prodetail= pro.productVo.product_detail;
	            		innerHtml += "<td>"+prodetail+"</td>";
	            		var qty= pro.branchStockVo.branch_stock_qty;
	            		innerHtml += "<td>"+qty+"</td>";
		      ...
		      var requestUrl = "${pageContext.request.contextPath }/sales/product_protype_process.do?";
	 ...
	 function f_del_file()
		...
		const urlParams = new URLSearchParams(window.location.search);
			...
			if(currPage==null)
		         ...
		         if(xmlhttp.readyState==4 && xmlhttp.status == 200){
		          ...
		          var innerHtml="";
		            for(pro of proList){
	            		...
	            		innerHtml += "<td>"+qty+"</td>";
	            		var proprice = pro.productVo.product_price; 
	            		innerHtml += "<td>"+numberFormat(proprice)+"</td>";
	            		innerHtml+="</tr>";
		            }
		      ...
		      var requestUrl = "${pageContext.request.contextPath }/sales/product_price_process.do?";
...
<div class="container-fluid">
         ...
         <!--  사이드바 끝   -->
            ...
            <div class="row">
                ...
                <div class="col" style="background-color:white">
                    ...
                    <div class="row mt-3">
                        <!--타이틀-->
                        <div class="col-4 mt-3" ><span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: rgb(46, 46, 46); font-weight:bold; font-size: 36px;">재고조회</span></div>
                        <div class="col"></div>
                        <!---네비게이터-->
                        <div class="col-7">
                            <div class="row">                                   
                                ...
                                <div class="col mt-5" style="display:inline;">     
                                    <ul style="list-style:none; margin-top: 10px; margin-bottom: 5px; margin-left: 100px; text-decoration-color: gray">
                                        <li>
                                            ...
                                            >
                                            <a style="color: gray; font-size: 14px" href="#">재고조회</a>
    ...
    <form action="./product_page.do" method="get">
    <div class="row">
    <div class="col-1"></div>
    <div class="col">
    ...
    <div class="col-1"></div>
   	...
   	<div class="col-3">정렬
   		<select class="mt-1" name="sort" id="sort" onchange="sendData()">
            <option value=1 selected>재고수량많은순
            <option value=2>재고수량적은순
               ...
               <div class="col-8"> <!-- 페이지 버튼 -->
                  <nav aria-label="Page navigation example">
                     <ul class="pagination">
                      ...
                      <li class="page-item<c:if test="${beginPage-1 <= 0}"> disabled</c:if>"><a class="ttt page-link" href="./product_page.do?currPage=${beginPage-1 }&product_no=${param.product_no}&product_name=${param.product_name}&sort=${param.sort}">이전</a></li>
                       <c:forEach begin="${beginPage }" end="${endPage }" var="i">
                          <li class="page-item<c:if test="${currPage==i}"> active</c:if>"><a class="ttt page-link" href="./product_page.do?currPage=${i}&product_no=${param.product_no}&product_name=${param.product_name}&sort=${param.sort}">${i}</a></li>
                       </c:forEach>
                      <li class="page-item<c:if test="${endPage+1 >= (totalCount-1)/10+1 }"> disabled</c:if>"><a class="ttt page-link" href="./product_page.do?currPage=${endPage+1 }&product_no=${param.product_no}&product_name=${param.product_name}&sort=${param.sort}">다음</a></li>
