      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <div class="col" style="background-color:white">
                ...
                <div class="row mt-3">
                    <!--타이틀-->
                    <div class="col-4 mt-3" ><span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: rgb(46, 46, 46); font-weight:bold; font-size: 36px;">퇴사자 등록</span></div>
                    <div class="col"></div>
                    <!---네비게이터-->
                    <div class="col-6">
                        <div class="row">                                   
                            ...
                            <div class="col mt-5" style="display:inline;">     
                                <ul style="list-style:none; margin-top: 10px; margin-bottom: 5px; margin-left: 100px; text-decoration-color: gray">
                                    <li>
                                        ...
                                        >
                                        <a style="color: gray; font-size: 14px" href="#">퇴사자 등록</a>
                                    </li>
                                </ul>             
                            </div>      
                        </div>
           ...
           <c:if test="${!empty sessionUser && sessionUser.deptTypeVo.dept_type_no==1}">
			...
			<form action="./employee_add_process.do" method="post"><!-- 테이블 내용 -->
               <div class="row mt-5">
                  <div class="col-3"></div>
                  <div class="col">
                  <table class="table table-hover shadow-sm p-3 mb-2 bg-white rounded">
                     <tbody>
                     <tr>
                        <th class="shadow-none p-3 mb-5 bg-light rounded"><h4>이름</h4></th>
                        <td><h4>${param.emp_name }</h4></td>
                        <td></td>
                     </tr>
                     
                     <tr>
                        <th class="shadow-none p-3 mb-5 bg-light rounded"><h4>사원번호</h4></th>
                        <td><h4>${param.emp_no }</h4></td>
                        <td></td>
                     </tr>
                     ...
                     <div class="row mt-3 mb-5">
                        ...
                        <div class="col"></div>
                        <div class="col-3">
						<a href="./employee_resignation_process.do?
									emp_code=${param.emp_code }&
									emp_name=${param.emp_name }&
									emp_no=${param.emp_no }" class="btn btn-warning btn-block">퇴사완료</a>      
			            </div>
                     </div>
