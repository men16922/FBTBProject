  ...
  <jsp:include page="../commons/production_nav.jsp"></jsp:include>
	...
	<div class="container-fluid">
      ...
      <div class="row">
         ...
         <div class="col">
            <!-- 게시글 상세 -->
            <form id="frm" 	action="${pageContext.request.contextPath }/sales/update_content_process.do" method="post" enctype="multipart/form-data">
			...
			<div class="row">
                  ...
                  <div class="col-3 mt-3 mb-5">
                     <a href="${pageContext.request.contextPath }/sales/main_page.do"><input type="button" class="btn btn-primary btn-block" value="목록으로"></a>
                  </div>
                  <div class="col-3 mt-3 mb-5">
