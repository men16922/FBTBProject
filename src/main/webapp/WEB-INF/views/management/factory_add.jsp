      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <div class="col" style="background-color:white">
                ...
                <div class="row mt-3">
                    <!--타이틀-->
                    <div class="col-4 mt-3" ><span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: rgb(46, 46, 46); font-weight:bold; font-size: 36px;">공장등록</span></div>
                    <div class="col"></div>
                    <!---네비게이터-->
                    <div class="col-6">
                        <div class="row">                                   
                            ...
                            <div class="col mt-5" style="display:inline;">     
                                <ul style="list-style:none; margin-top: 10px; margin-bottom: 5px; margin-left: 100px; text-decoration-color: gray">
                                    <li>
                                        ...
                                        >
                                        <a style="color: gray; font-size: 14px" href="${pageContext.request.contextPath }/management/factory_add.do">공장등록</a>
...
<c:if test="${!empty sessionUser && sessionUser.deptTypeVo.dept_type_no==1 }">
			...
			<form action = "./factory_add_process.do" method="get" id="frm" >     
			       <!-- 테이블 내용 -->
               <div class="row mt-5">
                  <div class="col-3"></div>
                  <div class="col">
                  <table class="table table-hover shadow-sm p-3 mb-2 bg-white rounded">
                     ...
                     <tr>
                        ...
                        <td><input id="branch_name" placeholder="공장명을 입력해주세요." name="branch_name" type="text" class="form-control"></td>
                        <td></td>
                     </tr>
