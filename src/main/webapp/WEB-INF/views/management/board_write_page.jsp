         ...
         <!--  사이드바 끝   -->
            ...
            <div class="row">
                ...
                <div class="col" style="background-color:white">
                    ...
                    <div class="row mt-3">
                        <!--타이틀-->
                        <div class="col-4 mt-3" ><span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: rgb(46, 46, 46); font-weight:bold; font-size: 36px;">부서게시글 쓰기</span></div>
                        <div class="col"></div>
                        <!---네비게이터-->
                        <div class="col-7">
                            <div class="row">                                   
                    ...
                    <form id="frm"
			action="${pageContext.request.contextPath }/management/board_write_process.do"
				...
				<div class="col">
					...
					<div class="row mb-3">
						<div class="col">
							<div class="input-group">
								...
								<input type="hidden" value="${sessionUser.employeeVo.emp_code }"
							...
							<div class="input-group mb-3">
								...
								<div class="custom-file">
									<input type="file" class="custom-file-input"
										...
										name="board_upload_files" multiple accept="image/*"> <label
										class="custom-file-label" for="inputGroupFile01">파일을
										선택해주세요</label>
								</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-3 mt-3 mb-5">
							<a href="${pageContext.request.contextPath }/management/main_page.do"><input
