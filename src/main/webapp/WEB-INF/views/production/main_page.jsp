					...
					<div class="col" style="background-color: white">
						...
						<div class="row mt-3">
							...
							<div class="col-4 mt-3">
								<span
									style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; color: rgb(46, 46, 46); font-weight: bold; font-size: 36px;">생산부
									게시판</span>
							</div>
							<div class="col"></div>
							<!---네비게이터-->
								...
								<div class="row">
									...
									<div class="col mt-5" style="display: inline;">
										<ul
											...
											<li><a style="color: gray; font-size: 14px" href="#">상세경로</a>
												...
												<c:forEach items="${noticelist }" var="data">
													<tr style="font-weight: bold" bgcolor="#e8ecf1">
														...
														<td class="text-center"><a
															href="${pageContext.request.contextPath }/production/board_read_page.do?dept_board_no=${data.departmentBoardVo.dept_board_no }">${data.departmentBoardVo.dept_board_title }</a></td>
								...
								<nav aria-label="Page navigation example">
									<ul class="pagination">
										<li
											...
											class="page-link"
											href="./main_page.do?currPage=${beginPage-1 }&searchWord=${param.searchWord}">이전</a></li>
										<c:forEach begin="${beginPage }" end="${endPage }" var="i">
											<!-- 띄어쓰기 주의 -->
											<li
												class="page-item<c:if test="${currPage==i }"> active</c:if>">
												<a class="page-link"
												href="./main_page.do?currPage=${i }&searchWord=${param.searchWord}">${i }</a>
											</li>
										</c:forEach>
										<li
											class="page-item<c:if test="${endPage+1 > (totalCount-1)/10+1 }"> disabled</c:if>"><a
											class="page-link"
											href="./main_page.do?currPage=${endPage+1 }&searchWord=${param.searchWord}">다음</a></li>
									</ul>
								</nav>
							</div>
							<div class="col">
								<a class="btn btn-primary btn-sm btn-block"
									href="${pageContext.request.contextPath }/production/board_write_page.do">글쓰기</a>
							</div>
						</div>
