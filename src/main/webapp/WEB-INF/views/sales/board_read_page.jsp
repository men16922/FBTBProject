...
<script type="text/javascript">
	...
	function writeReply(){
		...
		xmlhttp.open("post", "${pageContext.request.contextPath }/sales/write_reply_process.do", true);
		xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	 ...
	 { 
		 ...
		 // window.open("${pageContext.request.contextPath }/sales/update_reply_page.do?dept_board_reply_no=" +dept_board_reply_no, "update", "width=300, height=100, left=800, top=450"); 
		 //refreshReplyList();
	 }
	 ...
	 function updateReply(dept_board_reply_no,reply){
			...
			xmlhttp.open("post", "${pageContext.request.contextPath }/sales/update_reply_process.do", true);
			xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	 ...
	 function deleteReply(dept_board_reply_no){
			...
			xmlhttp.open("post", "${pageContext.request.contextPath }/sales/delete_reply_process.do", true);
			xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
					...
					<c:if
						...
						<div class="col-1">
							<a class="btn btn-outline-secondary btn-sm btn-block"
								href="${pageContext.request.contextPath }/sales/board_update_page.do?dept_board_no=${map.departmentBoardVo.dept_board_no }">수정</a>
						</div>
						<div class="col-1">
							<a class="btn btn-outline-secondary btn-sm btn-block"
								href="${pageContext.request.contextPath }/sales/delete_process.do?dept_board_no=${map.departmentBoardVo.dept_board_no }">삭제</a>
						</div>
					</c:if>
					<div class="col-1">
						<a class="btn btn-outline-secondary btn-sm btn-block"
							href="${pageContext.request.contextPath }/sales/main_page.do">목록</a>
					</div>
		</div>	
